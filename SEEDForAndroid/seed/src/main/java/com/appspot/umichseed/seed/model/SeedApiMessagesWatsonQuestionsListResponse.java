...
public final class SeedApiMessagesWatsonQuestionsListResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<SeedApiMessagesWatsonQuestionPut> questions;

  /**
   * ProtoRPC message definition to represent a watson question/answer pair
   * @return value or {@code null} for none
   */
  public java.util.List<SeedApiMessagesWatsonQuestionPut> getQuestions() {
    return questions;
  }
   ...
   */
  public SeedApiMessagesWatsonQuestionsListResponse setQuestions(java.util.List<SeedApiMessagesWatsonQuestionPut> questions) {
