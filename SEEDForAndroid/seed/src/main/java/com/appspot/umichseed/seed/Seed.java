...
/**
 * Service definition for Seed (v0.4.5).
 *
 * <p>
...
public class Seed extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "seed/v0.4.5/";
  ...
  public class Alerts {
     ...
     * AlertRequest parsed from the API request. Returns: An AlertListResponse message, for a patients
     * contains all of their emergency alerts, for a doctor contains all of their patient's alerts
     *
  ...
  public class PQualData {
     ...
     * parameters, call the {@link Put#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.appspot.umichseed.seed.model.MessagesPQualDataPut}
     * @return the request
     */
    public Put put(com.appspot.umichseed.seed.model.MessagesPQualDataPut content) throws java.io.IOException {
      Put result = new Put(content);
      initialize(result);
      return result;
    }
    ...
    public class Put extends SeedRequest<Void> {
       ...
       * @since 1.13
       */
      protected Put(com.appspot.umichseed.seed.model.MessagesPQualDataPut content) {
        super(Seed.this, "POST", REST_PATH, content, Void.class);
      }
  ...
  public class PatientManData {
     ...
     * parameters, call the {@link Put#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.appspot.umichseed.seed.model.MessagesPatientManualDataPut}
     * @return the request
     */
    public Put put(com.appspot.umichseed.seed.model.MessagesPatientManualDataPut content) throws java.io.IOException {
      Put result = new Put(content);
      initialize(result);
      return result;
    }
    ...
    public class Put extends SeedRequest<Void> {
       ...
       * @since 1.13
       */
      protected Put(com.appspot.umichseed.seed.model.MessagesPatientManualDataPut content) {
        super(Seed.this, "POST", REST_PATH, content, Void.class);
      }
