...
/**
 * Service definition for Seed (v0.4.0).
 *
 * <p>
...
public class Seed extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "seed/v0.4.0/";
  ...
  public class Doctor {
     ...
     * the API request. Returns: An instance of the newly inserted doctor (as a DoctorPut)
     *
    ...
    public class Put extends SeedRequest<com.appspot.umichseed.seed.model.SeedApiMessagesDoctorPut> {
      ...
      protected Put(com.appspot.umichseed.seed.model.SeedApiMessagesDoctorPut content) {
        super(Seed.this, "POST", REST_PATH, content, com.appspot.umichseed.seed.model.SeedApiMessagesDoctorPut.class);
      }
  ...
  public class PQualData {
     ...
     * instance of PQuantDataPut parsed from the API request. Returns: Nothing
     *
    ...
    public class Put extends SeedRequest<Void> {
      ...
      private static final String REST_PATH = "p_qual_data";
  ...
  public class WatsonQuestion {
     ...
     * WatsonQuestionPut parsed from the API request. Returns: An instance of the newly inserted
     * question (as a WatsonQuestionPut)
     *
    ...
    public class Put extends SeedRequest<com.appspot.umichseed.seed.model.SeedApiMessagesWatsonQuestionPut> {
      ...
      protected Put(com.appspot.umichseed.seed.model.SeedApiMessagesWatsonQuestionPut content) {
        super(Seed.this, "POST", REST_PATH, content, com.appspot.umichseed.seed.model.SeedApiMessagesWatsonQuestionPut.class);
      }
