...
/**
 * Service definition for Seed (v0.5.4).
 *
 * <p>
...
public class Seed extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "seed/v0.5.4/";
  ...
  /**
   * An accessor for creating requests from the AlertTest collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code Seed seed = new Seed(...);}
   *   {@code Seed.AlertTest.List request = seed.alertTest().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  public AlertTest alertTest() {
    return new AlertTest();
  }

  /**
   * The "alert_test" collection of methods.
   */
  public class AlertTest {
     ...
     *
     * Create a request for the method "alert_test.get".
     *
     * This request holds the parameters needed by the seed server.  After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.appspot.umichseed.seed.model.MessagesAlertTestRequest}
     * @return the request
     */
    public Get get(com.appspot.umichseed.seed.model.MessagesAlertTestRequest content) throws java.io.IOException {
      Get result = new Get(content);
      initialize(result);
      return result;
    }

    public class Get extends SeedRequest<Void> {

      private static final String REST_PATH = "alert_test";
       ...
       * @since 1.13
       */
      protected Get(com.appspot.umichseed.seed.model.MessagesAlertTestRequest content) {
