...
public final class SeedApiMessagesPQuantDataResponse extends com.google.api.client.json.GenericJson {
   ...
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key("toss_or_turn")
  private java.lang.String tossOrTurn;
   ...
   * @return value or {@code null} for none
   */
  public java.lang.String getTossOrTurn() {
    return tossOrTurn;
  }

  /**
   * @param tossOrTurn tossOrTurn or {@code null} for none
   */
  public SeedApiMessagesPQuantDataResponse setTossOrTurn(java.lang.String tossOrTurn) {
    this.tossOrTurn = tossOrTurn;
    return this;
  }
