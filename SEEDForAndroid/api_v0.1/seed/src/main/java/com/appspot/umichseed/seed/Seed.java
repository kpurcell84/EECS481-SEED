...
/**
 * Service definition for Seed (v0.1).
 *
 * <p>
...
public class Seed extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "seed/v0.1/";
  ...
  public class Doctor {
     ...
     * DoctorRequest parsed from the API request. Returns: An instance of DoctorPutMessage containing
     * all doctor info
     *
    ...
    public class Get extends SeedRequest<com.appspot.umichseed.seed.model.SeedApiMessagesDoctorPutMessage> {
       ...
       */
      protected Get() {
        super(Seed.this, "GET", REST_PATH, null, com.appspot.umichseed.seed.model.SeedApiMessagesDoctorPutMessage.class);
      }
    ...
    /**
     * Exposes an API endpoint to insert a doctor Args: request: An instance of DoctorPutMessage parsed
     * from the API request. Returns: An instance of the newly inserted doctor (as a DoctorPutMessage)
     *
     ...
     *
     * @param content the {@link com.appspot.umichseed.seed.model.SeedApiMessagesDoctorPutMessage}
     * @return the request
     */
    public Put put(com.appspot.umichseed.seed.model.SeedApiMessagesDoctorPutMessage content) throws java.io.IOException {
      Put result = new Put(content);
      initialize(result);
      return result;
    }

    public class Put extends SeedRequest<com.appspot.umichseed.seed.model.SeedApiMessagesDoctorPutMessage> {

      private static final String REST_PATH = "doctor";

      /**
       * Exposes an API endpoint to insert a doctor Args: request: An instance of DoctorPutMessage
       * parsed from the API request. Returns: An instance of the newly inserted doctor (as a
       * DoctorPutMessage)
       *
       * Create a request for the method "doctor.put".
       *
       ...
       * @since 1.13
       */
      protected Put(com.appspot.umichseed.seed.model.SeedApiMessagesDoctorPutMessage content) {
        super(Seed.this, "POST", REST_PATH, content, com.appspot.umichseed.seed.model.SeedApiMessagesDoctorPutMessage.class);
      }
  ...
  public class Patient {
     ...
     * PatientRequest parsed from the API request. Returns: An instance of PatientPutMessage containing
     * all patient info
     *
    ...
    public class Get extends SeedRequest<com.appspot.umichseed.seed.model.SeedApiMessagesPatientPutMessage> {

      private static final String REST_PATH = "patient";

      /**
       * Exposes an API endpoint to query a patient based on key (email) Args: request: An instance of
       * PatientRequest parsed from the API request. Returns: An instance of PatientPutMessage
       * containing all patient info
       *
       * Create a request for the method "patient.get".
       *
       * This request holds the parameters needed by the the seed server.  After setting any optional
       ...
       */
      protected Get() {
        super(Seed.this, "GET", REST_PATH, null, com.appspot.umichseed.seed.model.SeedApiMessagesPatientPutMessage.class);
      }
    ...
    /**
     * Exposes an API endpoint to insert a patient Args: request: An instance of PatientPutMessage
     * parsed from the API request. Returns: An instance of the newly inserted patient (as a
     * PatientPutMessage)
     *
     ...
     * parameters, call the {@link Put#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.appspot.umichseed.seed.model.SeedApiMessagesPatientPutMessage}
     * @return the request
     */
    public Put put(com.appspot.umichseed.seed.model.SeedApiMessagesPatientPutMessage content) throws java.io.IOException {
      Put result = new Put(content);
      initialize(result);
      return result;
    }

    public class Put extends SeedRequest<com.appspot.umichseed.seed.model.SeedApiMessagesPatientPutMessage> {
       ...
       * @since 1.13
       */
      protected Put(com.appspot.umichseed.seed.model.SeedApiMessagesPatientPutMessage content) {
        super(Seed.this, "POST", REST_PATH, content, com.appspot.umichseed.seed.model.SeedApiMessagesPatientPutMessage.class);
      }
  ...
  public class WatsonQuestion {
     ...
     * WatsonQuestionPutMessage parsed from the API request. Returns: An instance of the newly inserted
     * question (as a WatsonQuestionPutMessage)
     *
     ...
     * parameters, call the {@link Put#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.appspot.umichseed.seed.model.SeedApiMessagesWatsonQuestionPutMessage}
     * @return the request
     */
    public Put put(com.appspot.umichseed.seed.model.SeedApiMessagesWatsonQuestionPutMessage content) throws java.io.IOException {
      Put result = new Put(content);
      initialize(result);
      return result;
    }

    public class Put extends SeedRequest<com.appspot.umichseed.seed.model.SeedApiMessagesWatsonQuestionPutMessage> {

      private static final String REST_PATH = "watson_question";

      /**
       * Exposes an API endpoint to insert a watson question/answer pair Args: request: An instance of
       * WatsonQuestionPutMessage parsed from the API request. Returns: An instance of the newly
       * inserted question (as a WatsonQuestionPutMessage)
       *
       * Create a request for the method "watson_question.put".
       *
       * This request holds the parameters needed by the the seed server.  After setting any optional
       ...
       * @since 1.13
       */
      protected Put(com.appspot.umichseed.seed.model.SeedApiMessagesWatsonQuestionPutMessage content) {
        super(Seed.this, "POST", REST_PATH, content, com.appspot.umichseed.seed.model.SeedApiMessagesWatsonQuestionPutMessage.class);
      }
